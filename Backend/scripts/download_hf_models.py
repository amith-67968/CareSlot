...
def main():
    ...
    print("\n📥 Downloading facebook/bart-large-mnli (~1.6 GB)...")
    ...
    try:
        ...
        print("✅ facebook/bart-large-mnli downloaded and verified!")
        print(f"   Test result: {test_result['labels'][0]} ({test_result['scores'][0]:.3f})")

    except Exception as e:
        print(f"❌ Failed to download BART model: {e}")
    ...
    try:
        ...
        print(f"✅ all-MiniLM-L6-v2 downloaded and verified!")
